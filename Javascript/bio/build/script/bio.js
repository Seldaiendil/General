...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:bio.39eef13a222b.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
},$$registry:{},__v:function(){},__o:null,__p:function(){}}});
})();
...
qx.Bootstrap.define(a,{statics:{__bY:function(){if(qx.core&&qx.core.Environment){return qx.core.Environment.get(b);
}else{return !!qx.Bootstrap.getEnvironmentSetting(b);
}},setErrorHandler:function(c,d){this.__ca=c||null;
this.__cb=d||window;

if(this.__bY()){if(c&&window.onerror){var e=qx.Bootstrap.bind(this.__cd,this);

if(this.__cc==null){this.__cc=window.onerror;
}var self=this;
window.onerror=function(f,g,h){self.__cc(f,g,h);
e(f,g,h);
};
}
if(c&&!window.onerror){window.onerror=qx.Bootstrap.bind(this.__cd,this);
}if(this.__ca==null){if(this.__cc!=null){window.onerror=this.__cc;
this.__cc=null;
}else{window.onerror=null;
}}}},__cd:function(i,j,k){if(this.__ca){this.handleError(new qx.core.WindowError(i,j,k));
return true;
}},observeMethod:function(l){if(this.__bY()){var self=this;
return function(){if(!self.__ca){return l.apply(this,arguments);
}
try{return l.apply(this,arguments);
}catch(m){self.handleError(new qx.core.GlobalError(m,arguments));
}};
}else{return l;
}},handleError:function(n){if(this.__ca){this.__ca.call(this.__cb,n);
...
}this.__ce=b+(c&&c.message?c.message:c);
Error.call(this,this.__ce);
this.__ch=d;
this.__ci=c;
},members:{__ci:null,__ch:null,__ce:null,toString:function(){return this.__ce;
...
qx.Class.define(Q,{statics:{__bC:true,__bD:function(bA,bB){var bF=p;

for(var i=1,l=arguments.length;i<l;i++){bF=bF+this.__bE(arguments[i]);
}var bE=p;
...
if(this.__bC){qx.Bootstrap.error(bD);
}
if(qx.Class.isDefined(bh)){var bC=new qx.core.AssertionError(bA,bF);

if(this.__bC){qx.Bootstrap.error("Stack trace: \n"+bC.getStackTrace());
}throw bC;
}else{throw new Error(bD);
}},__bE:function(bG){var bH;
...
},assert:function(bI,bJ){bI==true||this.__bD(bJ||p,O);
},fail:function(bK,bL){var bM=bL?p:D;
this.__bD(bK||p,bM);
},assertTrue:function(bN,bO){(bN===true)||this.__bD(bO||p,u,bN,m);
},assertFalse:function(bP,bQ){(bP===false)||this.__bD(bQ||p,y,bP,m);
},assertEquals:function(bR,bS,bT){bR==bS||this.__bD(bT||p,k,bR,bm,bS,n);
},assertNotEquals:function(bU,bV,bW){bU!=bV||this.__bD(bW||p,k,bU,bq,bV,n);
},assertIdentical:function(bX,bY,ca){bX===bY||this.__bD(ca||p,k,bX,W,bY,n);
},assertNotIdentical:function(cb,cc,cd){cb!==cc||this.__bD(cd||p,k,cb,be,cc,n);
},assertNotUndefined:function(ce,cf){ce!==undefined||this.__bD(cf||p,bo);
},assertUndefined:function(cg,ch){cg===undefined||this.__bD(ch||p,t,cg,o);
},assertNotNull:function(ci,cj){ci!==null||this.__bD(cj||p,B);
},assertNull:function(ck,cl){ck===null||this.__bD(cl||p,F,ck,o);
...
cp.search(cq)>=0||this.__bD(cr||p,J,cp,bf,cq.toString(),n);
},assertArgumentsCount:function(cs,ct,cu,cv){var cw=cs.length;
(cw>=ct&&cw<=cu)||this.__bD(cv||p,M,ct,w,cu,bc,arguments.length,ba);
...
if(cQ==null){this.__bD(cP||p,s);
}cQ instanceof cN||this.__bD(cP||p,L,cN,bv,cQ);

if(cO){this.assertMatch(cQ.toString(),cO,cP);
}},assertInArray:function(cS,cT,cU){cT.indexOf(cS)!==-1||this.__bD(cU||p,bw,cS,bd,cT,m);
...
}}},assertKeyInMap:function(cY,da,db){da[cY]!==undefined||this.__bD(db||p,bw,cY,bg,da,m);
},assertFunction:function(dc,dd){qx.lang.Type.isFunction(dc)||this.__bD(dd||p,H,dc,o);
},assertString:function(de,df){qx.lang.Type.isString(de)||this.__bD(df||p,bp,de,o);
},assertBoolean:function(dg,dh){qx.lang.Type.isBoolean(dg)||this.__bD(dh||p,A,dg,o);
},assertNumber:function(di,dj){(qx.lang.Type.isNumber(di)&&isFinite(di))||this.__bD(dj||p,bi,di,o);
},assertPositiveNumber:function(dk,dl){(qx.lang.Type.isNumber(dk)&&isFinite(dk)&&dk>=0)||this.__bD(dl||p,R,dk,o);
},assertInteger:function(dm,dn){(qx.lang.Type.isNumber(dm)&&isFinite(dm)&&dm%1===0)||this.__bD(dn||p,C,dm,o);
},assertPositiveInteger:function(dp,dq){var dr=(qx.lang.Type.isNumber(dp)&&isFinite(dp)&&dp%1===0&&dp>=0);
dr||this.__bD(dq||p,br,dp,o);
},assertInRange:function(ds,dt,du,dv){(ds>=dt&&ds<=du)||this.__bD(dv||p,qx.lang.String.format(Y,[ds,dt,du]));
},assertObject:function(dw,dx){var dy=dw!==null&&(qx.lang.Type.isObject(dw)||typeof dw===bl);
dy||this.__bD(dx||p,T,(dw),o);
},assertArray:function(dz,dA){qx.lang.Type.isArray(dz)||this.__bD(dA||p,bt,dz,o);
},assertMap:function(dB,dC){qx.lang.Type.isObject(dB)||this.__bD(dC||p,v,dB,o);
},assertRegExp:function(dD,dE){qx.lang.Type.isRegExp(dD)||this.__bD(dE||p,r,dD,o);
},assertType:function(dF,dG,dH){this.assertString(dG,S);
typeof (dF)===dG||this.__bD(dH||p,c,dG,bz,dF,o);
},assertInstance:function(dI,dJ,dK){var dL=dJ.classname||dJ+p;
dI instanceof dJ||this.__bD(dK||p,bk,dL,bz,dI,o);
},assertInterface:function(dM,dN,dO){qx.Class.implementsInterface(dM,dN)||this.__bD(dO||p,x,dM,E,dN,n);
...
}catch(dW){this.__bD(dR||p,d,dP,j,dU.join(h),g,dQ,a);
}var dV=dU[0]==dT[0]&&dU[1]==dT[1]&&dU[2]==dT[2];
dV||this.__bD(dR||p,d,dU,j,dU.join(h),g,dQ,j,dT.join(h),P);
},assertElement:function(dX,dY){!!(dX&&dX.nodeType===1)||this.__bD(dY||p,q,dX,n);
},assertQxObject:function(ea,eb){this.__bF(ea,bu)||this.__bD(eb||p,K,ea,o);
},assertQxWidget:function(ec,ed){this.__bF(ec,z)||this.__bD(ed||p,b,ec,o);
},__bF:function(ee,ef){if(!ee){return false;
...
this.__bH=qx.dev.StackTrace.getStackTrace();
},members:{__bH:null,getStackTrace:function(){return this.__bH;
}}});
})();
...
qx.Class.define(d,{statics:{inShutDown:false,__q:{},__bU:0,__bV:[],__bW:e,__bX:{},register:function(j){var n=this.__q;
...
}}}},fromHashCode:function(y){return this.__q[y]||null;
...
},members:{__cF:null,__cG:null,__cH:null,__cI:null,stringify:function(bb,bc,bd){this.__cF=p;
this.__cG=p;
this.__cI=[];

if(qx.lang.Type.isNumber(bd)){var bd=Math.min(10,Math.floor(bd));

for(var i=0;i<bd;i+=1){this.__cG+=O;
}}else if(qx.lang.Type.isString(bd)){if(bd.length>10){bd=bd.slice(0,10);
}this.__cG=bd;
}if(bc&&(qx.lang.Type.isFunction(bc)||qx.lang.Type.isArray(bc))){this.__cH=bc;
}else{this.__cH=null;
}return this.__cJ(p,{'':bb});
},__cJ:function(be,bf){var bi=this.__cF,bg,bj=bf[be];
if(bj&&qx.lang.Type.isFunction(bj.toJSON)){bj=bj.toJSON(be);
}else if(qx.lang.Type.isDate(bj)){bj=this.dateToJSON(bj);
}if(typeof this.__cH===e){bj=this.__cH.call(bf,be,bj);
}
if(bj===null){return h;
}
if(bj===undefined){return undefined;
}switch(qx.lang.Type.getClass(bj)){case R:return this.__cK(bj);
case B:return isFinite(bj)?String(bj):h;
case Q:return String(bj);
case J:this.__cF+=this.__cG;
bg=[];

if(this.__cI.indexOf(bj)!==-1){throw new TypeError(V);
}this.__cI.push(bj);
var length=bj.length;

for(var i=0;i<length;i+=1){bg[i]=this.__cJ(i,bj)||h;
}this.__cI.pop();
if(bg.length===0){var bh=s;
}else if(this.__cF){bh=E+this.__cF+bg.join(Y+this.__cF)+b+bi+l;
}else{bh=N+bg.join(d)+l;
}this.__cF=bi;
return bh;
case z:this.__cF+=this.__cG;
bg=[];

if(this.__cI.indexOf(bj)!==-1){throw new TypeError(V);
}this.__cI.push(bj);
if(this.__cH&&typeof this.__cH===f){var length=this.__cH.length;

for(var i=0;i<length;i+=1){var k=this.__cH[i];

if(typeof k===W){var v=this.__cJ(k,bj);

if(v){bg.push(this.__cK(k)+(this.__cF?g:m)+v);
}}}}else{for(var k in bj){if(Object.hasOwnProperty.call(bj,k)){var v=this.__cJ(k,bj);

if(v){bg.push(this.__cK(k)+(this.__cF?g:m)+v);
}}}}this.__cI.pop();
if(bg.length===0){var bh=A;
}else if(this.__cF){bh=w+this.__cF+bg.join(Y+this.__cF)+b+bi+S;
...
return typeof bs===e?this.__cL({'':j},p,bs):j;
}throw new SyntaxError(P);
},__cL:function(bu,bv,bw){var bx=bu[bv];

if(bx&&typeof bx===f){for(var k in bx){if(Object.hasOwnProperty.call(bx,k)){var v=this.__cL(bx,k,bw);
...
(function(){var r="|bubble",q="|capture",p="|",o="",n="_",m="unload",k="UNKNOWN_",j="c",h="__bO",g="DOM_",c="__bN",f="WIN_",e="QX_",b="qx.event.Manager",a="capture",d="DOCUMENT_";
...
},getAllListeners:function(){return this.__bM;
...
qx.Class.define(c,{statics:{__cy:{},getManager:function(d){if(d==null){d=window;
...
},PRIORITY_FIRST:-32000,PRIORITY_NORMAL:0,PRIORITY_LAST:32000,__bN:[],addHandler:function(Q){this.__bN.push(Q);
this.__bN.sort(function(a,b){return a.PRIORITY-b.PRIORITY;
});
},getHandlers:function(){return this.__bN;
},__bO:[],addDispatcher:function(R,S){this.__bO.push(R);
this.__bO.sort(function(a,b){return a.PRIORITY-b.PRIORITY;
});
},getDispatchers:function(){return this.__bO;
}}});
})();
(function(){var a="qx.lang.RingBuffer";
qx.Class.define(a,{extend:Object,construct:function(b){this.setMaxEntries(b||50);
},members:{__cj:0,__ck:0,__cl:false,__cm:0,__cn:null,__co:null,setMaxEntries:function(c){this.__co=c;
this.clear();
},getMaxEntries:function(){return this.__co;
},addEntry:function(d){this.__cn[this.__cj]=d;
this.__cj=this.__cp(this.__cj,1);
var e=this.getMaxEntries();

if(this.__ck<e){this.__ck++;
}if(this.__cl&&(this.__cm<e)){this.__cm++;
}},mark:function(){this.__cl=true;
this.__cm=0;
},clearMark:function(){this.__cl=false;
},getAllEntries:function(){return this.getEntries(this.getMaxEntries(),false);
},getEntries:function(f,g){if(f>this.__ck){f=this.__ck;
}if(g&&this.__cl&&(f>this.__cm)){f=this.__cm;
}
if(f>0){var i=this.__cp(this.__cj,-1);
var h=this.__cp(i,-f+1);
var j;

if(h<=i){j=this.__cn.slice(h,i+1);
}else{j=this.__cn.slice(h,this.__ck).concat(this.__cn.slice(0,i+1));
}}else{j=[];
}return j;
},clear:function(){this.__cn=new Array(this.getMaxEntries());
this.__ck=0;
this.__cm=0;
this.__cj=0;
},__cp:function(k,l){var m=this.getMaxEntries();
var n=(k+l)%m;
if(n<0){n+=m;
}return n;
}}});
...
qx.Class.define(s,{statics:{__cq:A,setLevel:function(I){this.__cq=I;
},getLevel:function(){return this.__cq;
},setTreshold:function(J){this.__ct.setMaxMessages(J);
},getTreshold:function(){return this.__ct.getMaxMessages();
},__cr:{},__cs:0,register:function(K){if(K.$$id){return;
}var M=this.__cs++;
this.__cr[M]=K;
K.$$id=M;
var L=this.__cu;
var N=this.__ct.getAllLogEvents();

for(var i=0,l=N.length;i<l;i++){if(L[N[i].level]>=L[this.__cq]){K.process(N[i]);
}}},unregister:function(O){var P=O.$$id;

if(P==null){return;
}delete this.__cr[P];
delete O.$$id;
},debug:function(Q,R){qx.log.Logger.__cv(A,arguments);
},info:function(S,T){qx.log.Logger.__cv(e,arguments);
},warn:function(U,V){qx.log.Logger.__cv(r,arguments);
},error:function(W,X){qx.log.Logger.__cv(j,arguments);
},trace:function(Y){qx.log.Logger.__cv(e,[Y,qx.dev.StackTrace.getStackTrace().join(u)]);
...
},__ct:new qx.log.appender.RingBuffer(50),__cu:{debug:0,info:1,warn:2,error:3},__cv:function(bv,bw){var bB=this.__cu;

if(bB[bv]<bB[this.__cq]){return;
}var by=bw.length<2?null:bw[0];
var bA=by?1:0;
var bx=[];

for(var i=bA,l=bw.length;i<l;i++){bx.push(this.__cx(bw[i],true));
}var bC=new Date;
var bD={time:bC,offset:bC-qx.Bootstrap.LOADSTART,level:bv,items:bx,win:window};
if(by){if(by.$$hash!==undefined){bD.object=by.$$hash;
}else if(by.$$type){bD.clazz=by;
}}this.__ct.process(bD);
var bE=this.__cr;

for(var bz in bE){bE[bz].process(bD);
}},__cw:function(bF){if(bF===undefined){return y;
...
},__cx:function(bH,bI){var bP=this.__cw(bH);
var bL=D;
var bK=[];
...
for(var i=0;i<bR.length;i++){bQ.__cv(bR[i][0],bR[i][1]);
...
},__cz:qx.event.Registration,addListener:function(H,I,self,J){if(!this.$$disposed){return this.__cz.addListener(this,H,I,self,J);
}return null;
},addListenerOnce:function(K,L,self,M){var N=function(e){this.removeListener(K,N,this,M);
L.call(self||this,e);
};
return this.addListener(K,N,this,M);
},removeListener:function(O,P,self,Q){if(!this.$$disposed){return this.__cz.removeListener(this,O,P,self,Q);
}return false;
},removeListenerById:function(R){if(!this.$$disposed){return this.__cz.removeListenerById(this,R);
}return false;
},hasListener:function(S,T){return this.__cz.hasListener(this,S,T);
},dispatchEvent:function(U){if(!this.$$disposed){return this.__cz.dispatchEvent(this,U);
}return true;
},fireEvent:function(V,W,X){if(!this.$$disposed){return this.__cz.fireEvent(this,V,W,X);
}return true;
},fireNonBubblingEvent:function(Y,ba,bb){if(!this.$$disposed){return this.__cz.fireNonBubblingEvent(this,Y,ba,bb);
}return true;
},fireDataEvent:function(bc,bd,be,bf){if(!this.$$disposed){if(be===undefined){be=null;
}return this.__cz.fireNonBubblingEvent(this,bc,qx.event.type.Data,[bd,be,!!bf]);
}return true;
},__cA:null,setUserData:function(bg,bh){if(!this.__cA){this.__cA={};
}this.__cA[bg]=bh;
},getUserData:function(bi){if(!this.__cA){return null;
}var bj=this.__cA[bi];
return bj===undefined?null:bj;
},__cB:qx.log.Logger,debug:function(bk){this.__cC(f,arguments);
},info:function(bl){this.__cC(m,arguments);
},warn:function(bm){this.__cC(h,arguments);
},error:function(bn){this.__cC(j,arguments);
},trace:function(){this.__cB.trace(this);
},__cC:function(bo,bp){var bq=qx.lang.Array.fromArguments(bp);
bq.unshift(this);
this.__cB[bo].apply(this.__cB,bq);
...
}},__cD:null,__cE:function(){var bx=qx.Class.getProperties(this.constructor);
...
},statics:{__q:qx.$$resources||{},__dS:{}},members:{has:function(q){return !!this.self(arguments).__q[q];
},getData:function(r){return this.self(arguments).__q[r]||null;
},getImageWidth:function(s){var t=this.self(arguments).__q[s];
return t?t[0]:null;
},getImageHeight:function(u){var v=this.self(arguments).__q[u];
return v?v[1]:null;
},getImageFormat:function(w){var x=this.self(arguments).__q[w];
return x?x[2]:null;
},getCombinedFormat:function(y){var B=p;
var A=this.self(arguments).__q[y];
var z=A&&A.length>4&&typeof (A[4])==k&&this.constructor.__q[A[4]];

if(z){var D=A[4];
var C=this.constructor.__q[D];
B=C[2];
}return B;
},toUri:function(E){if(E==null){return E;
}var F=this.self(arguments).__q[E];
...
},toDataUri:function(I){var K=this.constructor.__q[I];
var L=this.constructor.__q[K[4]];
var M;
...
},members:{__ca:null,__cb:null,__eI:null,cancel:function(){this.__eI.cancel(this);
},schedule:function(){this.__eI.schedule(this);
},call:function(){var d;
this.__cb?this.__ca.apply(this.__cb):this.__ca();
}},destruct:function(){this.cancel();
this.__cb=this.__ca=this.__eI=null;
}});
})();
...
this.__eI=f;
this.__bJ=f.getWindow();
this._initObserver();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{orientationchange:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__eI:null,__bJ:null,__fr:null,__fs:null,__ft:null,canHandleEvent:function(g,h){},registerEvent:function(i,j,k){},unregisterEvent:function(l,m,n){},_initObserver:function(){this.__ft=qx.lang.Function.listener(this._onNative,this);
this.__fr=qx.bom.Event.supportsEvent(this.__bJ,e)?e:d;
var Event=qx.bom.Event;
Event.addNativeListener(this.__bJ,this.__fr,this.__ft);
},_stopObserver:function(){var Event=qx.bom.Event;
Event.removeNativeListener(this.__bJ,this.__fr,this.__ft);
},_onNative:qx.event.GlobalError.observeMethod(function(o){var q=qx.bom.Viewport;
var p=q.getOrientation();

if(this.__fs!=p){this.__fs=p;
var r=q.isLandscape()?c:b;
qx.event.Registration.fireEvent(this.__bJ,e,qx.event.type.Orientation,[p,r]);
}})},destruct:function(){this._stopObserver();
this.__eI=this.__bJ=null;
...
qx.Class.define(a,{extend:qx.core.Object,implement:qx.event.IEventHandler,construct:function(b){qx.core.Object.call(this);
this.__eI=b;
this.__bJ=b.getWindow();
},statics:{PRIORITY:qx.event.Registration.PRIORITY_NORMAL,SUPPORTED_TYPES:{useraction:1},TARGET_CHECK:qx.event.IEventHandler.TARGET_WINDOW,IGNORE_CAN_HANDLE:true},members:{__eI:null,__bJ:null,canHandleEvent:function(c,d){},registerEvent:function(e,f,g){},unregisterEvent:function(h,i,j){}},destruct:function(){this.__eI=this.__bJ=null;
...
}qx.event.Registration.fireEvent(this.__bJ,h,qx.event.type.Data,[G]);
...
this.__eI=this.__bJ=this.__cX=this.__fD=null;
...
}qx.event.Registration.fireEvent(this.__bJ,b,qx.event.type.Data,[E||D.type]);
},__fX:function(){var H=[this.__bJ,this.__cX,this.__cX.body];
var I=this.__bJ;
var G=h;
...
this.__eI=this.__bJ=this.__cX=this.__fW=null;
...
this.__eI=by;
this.__bJ=by.getWindow();
if((qx.core.Environment.get(l)==bt)){this.__cX=this.__bJ;
}else{this.__cX=this.__bJ.document.documentElement;
}this.__gi={};
...
}}},members:{__gj:null,__eI:null,__bJ:null,__cX:null,__gi:null,__gk:null,__gl:null,__gm:null,canHandleEvent:function(bB,bC){},registerEvent:function(bD,bE,bF){},unregisterEvent:function(bG,bH,bI){},_fireInputEvent:function(bJ,bK){var bL=this.__gn();
...
}if(this.__bJ){qx.event.Registration.fireEvent(this.__bJ,s,qx.event.type.Data,[q]);
...
}}}if(this.__bJ){qx.event.Registration.fireEvent(this.__bJ,s,qx.event.type.Data,[bN]);
...
this.__gk=this.__eI=this.__bJ=this.__cX=this.__gi=null;
...
this.__bJ=j.getWindow();
this.__bL=k;
j.addListener(this.__bJ,f,this.releaseCapture,this);
j.addListener(this.__bJ,e,this.releaseCapture,this);
j.addListener(this.__bJ,a,this.releaseCapture,this);
},statics:{PRIORITY:qx.event.Registration.PRIORITY_FIRST},members:{__bL:null,__ho:null,__hp:true,__bJ:null,_getParent:function(l){return l.parentNode;
...
this.__ho=q;
this.__bL.fireEvent(q,b,qx.event.type.Event,[true,false]);
},getCaptureElement:function(){return this.__ho;
},releaseCapture:function(){var s=this.__ho;

if(!s){return;
}this.__ho=null;
this.__bL.fireEvent(s,h,qx.event.type.Event,[true,false]);
...
},"default":qx.lang.Function.empty})},destruct:function(){this.__ho=this.__bJ=this.__bL=null;
...
this.__hx=e;
this.__cs=f||e.toHashCode();

if(e===null)throw new Error('Decorator not found --['+f+']--');
this.useMarkup(e.getMarkup());
},members:{__cs:null,__hx:null,getId:function(){return this.__cs;
...
(function(){var cd="px",cc="Boolean",cb="qx.event.type.Drag",ca="qx.event.type.Mouse",bY="visible",bX="qx.event.type.Focus",bW="Integer",bV="qx.event.type.Touch",bU="qx.event.type.Data",bT="excluded",bx="_applyPadding",bw="qx.event.type.Event",bv="on",bu="hidden",bt="engine.name",bs="contextmenu",br="String",bq="tabIndex",bp="focused",bo="changeVisibility",ck="mshtml",cl="hovered",ci="qx.event.type.KeySequence",cj="absolute",cg="backgroundColor",ch="drag",ce="div",cf="disabled",cm="move",cn="dragstart",bM="qx.dynlocale",bL="dragchange",bO="dragend",bN="resize",bQ="Decorator",bP="zIndex",bS="opacity",bR="default",bK="Color",bJ="eyeos.debug",c='.',d="changeToolTipText",f="beforeContextmenuOpen",g="_applyNativeContextMenu",h="__hR",j="__id",k="_applyBackgroundColor",m="event.pointer",n="_applyFocusable",o="changeShadow",cr="qx.event.type.KeyInput",cq="createChildControl",cp="__hS",co="Font",cv="_applyShadow",cu="_applyEnabled",ct="_applySelectable",cs="Number",cx="_applyKeepActive",cw="_applyVisibility",N="repeat",O="qxDraggable",L="syncAppearance",M="paddingLeft",R="__ib",S="_applyDroppable",P="#",Q="qx.event.type.MouseWheel",J="_applyCursor",K="_applyDraggable",w="changeTextColor",v="$$widget",y="changeContextMenu",x="paddingTop",s="changeSelectable",r="hideFocus",u="none",t="outline",q="_applyAppearance",p="_applyOpacity",X="url(",Y=")",ba="qx.ui.core.Widget",bb="_applyFont",T="cursor",U="qxDroppable",V="changeZIndex",W="__hV",bc="changeEnabled",bd="__hW",G="changeFont",F="_applyDecorator",E="_applyZIndex",D="_applyTextColor",C="qx.ui.menu.Menu",B='content',A="_applyToolTipText",z="true",I="__if",H="widget",be="changeDecorator",bf="_applyTabIndex",bg="changeAppearance",bh='container',bi="shorthand",bj="/",bk="",bl="_applyContextMenu",bm="paddingBottom",bn="changeNativeContextMenu",bB="undefined",bA="qx.ui.tooltip.ToolTip",bz="qxKeepActive",by="_applyKeepFocus",bF="paddingRight",bE="changeBackgroundColor",bD="changeLocale",bC="__hX",bH="qxKeepFocus",bG="opera",bI="qx/static/blank.gif";
...
},events:{appear:bw,disappear:bw,createChildControl:bU,resize:bU,move:bU,syncAppearance:bU,mousemove:ca,mouseover:ca,mouseout:ca,mousedown:ca,mouseup:ca,click:ca,dblclick:ca,contextmenu:ca,beforeContextmenuOpen:bU,mousewheel:Q,touchstart:bV,touchend:bV,touchmove:bV,touchcancel:bV,tap:bV,swipe:bV,keyup:ci,keydown:ci,keypress:ci,keyinput:cr,focus:bX,blur:bX,focusin:bX,focusout:bX,activate:bX,deactivate:bX,capture:bw,losecapture:bw,drop:cb,dragleave:cb,dragover:cb,drag:cb,dragstart:cb,dragend:cb,dragchange:cb,droprequest:cb},properties:{paddingTop:{check:bW,init:0,apply:bx,themeable:true},paddingRight:{check:bW,init:0,apply:bx,themeable:true},paddingBottom:{check:bW,init:0,apply:bx,themeable:true},paddingLeft:{check:bW,init:0,apply:bx,themeable:true},padding:{group:[x,bF,bm,M],mode:bi,themeable:true},zIndex:{nullable:true,init:null,apply:E,event:V,check:bW,themeable:true},decorator:{nullable:true,init:null,apply:F,event:be,check:bQ,themeable:true},shadow:{nullable:true,init:null,apply:cv,event:o,check:bQ,themeable:true},backgroundColor:{nullable:true,check:bK,apply:k,event:bE,themeable:true},textColor:{nullable:true,check:bK,apply:D,event:w,themeable:true,inheritable:true},font:{nullable:true,apply:bb,check:co,event:G,themeable:true,inheritable:true,dereference:true},opacity:{check:cs,apply:p,themeable:true,nullable:true,init:null},cursor:{check:br,apply:J,themeable:true,inheritable:true,nullable:true,init:null},toolTip:{check:bA,nullable:true},toolTipText:{check:br,nullable:true,event:d,apply:A},toolTipIcon:{check:br,nullable:true,event:d},blockToolTip:{check:cc,init:false},visibility:{check:[bY,bu,bT],init:bY,apply:cw,event:bo},enabled:{init:true,check:cc,inheritable:true,apply:cu,event:bc},anonymous:{init:false,check:cc},tabIndex:{check:bW,nullable:true,apply:bf},focusable:{check:cc,init:false,apply:n},keepFocus:{check:cc,init:false,apply:by},keepActive:{check:cc,init:false,apply:cx},draggable:{check:cc,init:false,apply:K},droppable:{check:cc,init:false,apply:S},selectable:{check:cc,init:false,event:s,apply:ct},contextMenu:{check:C,apply:bl,nullable:true,event:y},nativeContextMenu:{check:cc,init:false,themeable:true,event:bn,apply:g},appearance:{check:br,init:H,apply:q,event:bg}},statics:{DEBUG:false,getWidgetByElement:function(cy,cz){while(cy){var cA=cy.$$widget;
if(cA!=null){var cB=qx.core.ObjectRegistry.fromHashCode(cA);
if(!cz||!cB.getAnonymous()){return cB;
...
},_setLayout:function(cD){if(this.__ib){this.__ib.connectToWidget(null);
}
...
if(this.$$parent&&!this.$$parent.$$disposed){this.$$parent.getContentElement().remove(cE);
}this.$$parent=parent||null;

if(parent&&!parent.$$disposed){this.$$parent.getContentElement().add(cE);
...
},renderLayout:function(cI,top,cJ,cK){var cT=qx.ui.core.LayoutItem.prototype.renderLayout.call(this,cI,top,cJ,cK);
if(!cT){return null;
}var cM=this.getContainerElement();
var content=this.getContentElement();
var cQ=cT.size||this._updateInsets;
var cU=cd;
var cR={};
if(cT.position){cR.left=cI+cU;
cR.top=top+cU;
}if(cT.size){cR.width=cJ+cU;
cR.height=cK+cU;
}
if(cT.position||cT.size){cM.setStyles(cR);
}
if(cQ||cT.local||cT.margin){var cL=this.getInsets();
var innerWidth=cJ-cL.left-cL.right;
var innerHeight=cK-cL.top-cL.bottom;
innerWidth=innerWidth<0?0:innerWidth;
innerHeight=innerHeight<0?0:innerHeight;
}var cO={};

if(this._updateInsets){cO.left=cL.left+cU;
cO.top=cL.top+cU;
}
if(cQ){cO.width=innerWidth+cU;
cO.height=innerHeight+cU;
}
if(cQ||this._updateInsets){content.setStyles(cO);
}
if(cT.size){var cS=this.__hX;

if(cS){cS.setStyles({width:cJ+cd,height:cK+cd});
}}
if(cT.size||this._updateInsets){if(this.__hV){this.__hV.resize(cJ,cK);
}}
if(cT.size){if(this.__hW){var cL=this.__hW.getInsets();
var cP=cJ+cL.left+cL.right;
var cN=cK+cL.top+cL.bottom;
this.__hW.resize(cP,cN);
}}
if(cQ||cT.local||cT.margin){if(this.__ib&&this.hasLayoutChildren()){this.__ib.renderLayout(innerWidth,innerHeight);
}else if(this.hasLayoutChildren()){throw new Error("At least one child in control "+this._findTopControl()+" requires a layout, but no one was defined!");
}}if(cT.position&&this.hasListener(cm)){this.fireDataEvent(cm,this.getBounds());
}
if(cT.size&&this.hasListener(bN)){this.fireDataEvent(bN,this.getBounds());
}delete this._updateInsets;
return cT;
},__id:null,clearSeparators:function(){var cW=this.__id;

if(!cW){return;
}var cX=qx.ui.core.Widget.__hT;
var content=this.getContentElement();
var cV;
...
},renderSeparator:function(cY,da){var db=qx.ui.core.Widget.__hT.getDecoratorElement(cY);
this.getContentElement().add(db);
db.resize(da.width,da.height);
db.setStyles({left:da.left+cd,top:da.top+cd});
if(!this.__id){this.__id=[db];
}else{this.__id.push(db);
}},_computeSizeHint:function(){var di=this.getWidth();
var dh=this.getMinWidth();
var dd=this.getMaxWidth();
var dg=this.getHeight();
var de=this.getMinHeight();
var df=this.getMaxHeight();
var dj=this._getContentHint();
var dc=this.getInsets();
var dl=dc.left+dc.right;
var dk=dc.top+dc.bottom;

if(di==null){di=dj.width+dl;
}
if(dg==null){dg=dj.height+dk;
}
if(dh==null){dh=dl;

if(dj.minWidth!=null){dh+=dj.minWidth;
if(dh>dd&&dd!=null){dh=dd;
}}}
if(de==null){de=dk;

if(dj.minHeight!=null){de+=dj.minHeight;
if(de>df&&df!=null){de=df;
}}}
if(dd==null){if(dj.maxWidth==null){dd=Infinity;
}else{dd=dj.maxWidth+dl;
if(dd<dh&&dh!=null){dd=dh;
}}}
if(df==null){if(dj.maxHeight==null){df=Infinity;
}else{df=dj.maxHeight+dk;
if(df<de&&de!=null){df=de;
}}}return {width:di,minWidth:dh,maxWidth:dd,height:dg,minHeight:de,maxHeight:df};
},invalidateLayoutCache:function(){qx.ui.core.LayoutItem.prototype.invalidateLayoutCache.call(this);

if(this.__ib){this.__ib.invalidateLayoutCache();
}},_getContentHint:function(){var dn=this.__ib;

if(dn){if(this.hasLayoutChildren()){var dm;
var dp=dn.getSizeHint();
return dp;
}else{return {width:0,height:0};
}}else{return {width:100,height:50};
}},_getHeightForWidth:function(dq){var du=this.getInsets();
var dx=du.left+du.right;
var dw=du.top+du.bottom;
var dv=dq-dx;
var ds=this._getLayout();

if(ds&&ds.hasHeightForWidth()){var dr=ds.getHeightForWidth(dq);
}else{dr=this._getContentHeightForWidth(dv);
}var dt=dr+dw;
return dt;
},_getContentHeightForWidth:function(dy){throw new Error("Abstract method call: _getContentHeightForWidth()!");
},getInsets:function(){var top=this.getPaddingTop();
var dA=this.getPaddingRight();
var dC=this.getPaddingBottom();
var dB=this.getPaddingLeft();

if(this.__hV){var dz=this.__hV.getInsets();
top+=dz.top;
dA+=dz.right;
dC+=dz.bottom;
dB+=dz.left;
}return {"top":top,"right":dA,"bottom":dC,"left":dB};
},getInnerSize:function(){var dE=this.getBounds();

if(!dE){return null;
}var dD=this.getInsets();
return {width:dE.width-dD.left-dD.right,height:dE.height-dD.top-dD.bottom};
},show:function(){this.setVisibility(bY);
},hide:function(){this.setVisibility(bu);
},exclude:function(){this.setVisibility(bT);
},isVisible:function(){return this.getVisibility()===bY;
},isHidden:function(){return this.getVisibility()!==bY;
},isExcluded:function(){return this.getVisibility()===bT;
},isSeeable:function(){var dG=this.getContainerElement().getDomElement();

if(dG){return dG.offsetWidth>0;
}var dF=this;

do{if(!dF.isVisible()){return false;
}
if(dF.isRootWidget()){return true;
}dF=dF.getLayoutParent();
}while(dF);
return false;
},_createContainerElement:function(){if(qx.core.Environment.get(bJ)){var dI={"$$widget":this.toHashCode(),"data-qx-widget":this.toString().split(c).pop(),"data-qx-widget-element":bh,"data-qx-appearance":this.getAppearance(),"data-qx-fullname":this.toString()};
}else{var dI={"$$widget":this.toHashCode()};
}var dH={zIndex:0,position:cj};
return new qx.html.Element(ce,dH,dI);
},__ie:function(){var dJ=this._createContentElement();

if(qx.core.Environment.get(bJ)){dJ.setAttributes({"data-qx-widget":this.toString().split(c).pop(),"data-qx-widget-element":B});
}dJ.setStyles({"position":cj,"zIndex":10});
return dJ;
},_createContentElement:function(){return new qx.html.Element(ce,{overflowX:bu,overflowY:bu});
...
},__if:null,getLayoutChildren:function(){var dL=this.__if;

if(!dL){return this.__ig;
}var dM;

for(var i=0,l=dL.length;i<l;i++){var dK=dL[i];

if(dK.hasUserBounds()||dK.isExcluded()){if(dM==null){dM=dL.concat();
}qx.lang.Array.remove(dM,dK);
}}return dM||dL;
},scheduleLayoutUpdate:function(){qx.ui.core.queue.Layout.add(this);
},invalidateLayoutChildren:function(){var dN=this.__ib;

if(dN){dN.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
},hasLayoutChildren:function(){var dO=this.__if;
...
if(!dP.hasUserBounds()&&!dP.isExcluded()){return true;
}}return false;
},getChildrenContainer:function(){return this;
},__ig:[],_getChildren:function(){return this.__if||this.__ig;
},_indexOf:function(dQ){var dR=this.__if;

if(!dR){return -1;
}return dR.indexOf(dQ);
},_hasChildren:function(){var dS=this.__if;
return dS!=null&&(!!dS[0]);
},addChildrenToQueue:function(dT){var dU=this.__if;
...
dT.push(dV);
dV.addChildrenToQueue(dT);
}},_add:function(dW,dX){if(dW.getLayoutParent()==this){qx.lang.Array.remove(this.__if,dW);
}
if(this.__if){this.__if.push(dW);
}else{this.__if=[dW];
}this.__ih(dW,dX);
},_addAt:function(dY,ea,eb){if(!this.__if){this.__if=[];
}if(dY.getLayoutParent()==this){qx.lang.Array.remove(this.__if,dY);
}var ec=this.__if[ea];

if(ec===dY){dY.setLayoutProperties(eb);
}
if(ec){qx.lang.Array.insertBefore(this.__if,dY,ec);
}else{this.__if.push(dY);
}this.__ih(dY,eb);
},_addBefore:function(ed,ee,ef){if(ed==ee){return;
}
if(!this.__if){this.__if=[];
}if(ed.getLayoutParent()==this){qx.lang.Array.remove(this.__if,ed);
}qx.lang.Array.insertBefore(this.__if,ed,ee);
this.__ih(ed,ef);
},_addAfter:function(eg,eh,ei){if(eg==eh){return;
}
if(!this.__if){this.__if=[];
}if(eg.getLayoutParent()==this){qx.lang.Array.remove(this.__if,eg);
}qx.lang.Array.insertAfter(this.__if,eg,eh);
this.__ih(eg,ei);
},_remove:function(ej){if(!this.__if){throw new Error("This widget has no children!");
}qx.lang.Array.remove(this.__if,ej);
this.__ii(ej);
},_removeAt:function(ek){if(!this.__if){throw new Error("This widget has no children!");
}var em=this.__if[ek];
qx.lang.Array.removeAt(this.__if,ek);
this.__ii(em);
return em;
},_removeAll:function(){if(!this.__if){return [];
}var en=this.__if.concat();
this.__if.length=0;

for(var i=en.length-1;i>=0;i--){this.__ii(en[i]);
}qx.ui.core.queue.Layout.add(this);
return en;
},_afterAddChild:null,_afterRemoveChild:null,__ih:function(eo,ep){var parent=eo.getLayoutParent();

if(parent&&parent!=this){parent._remove(eo);
}eo.setLayoutParent(this);
if(ep){eo.setLayoutProperties(ep);
}else{this.updateLayoutProperties();
}if(this._afterAddChild){this._afterAddChild(eo);
}},__ii:function(eq){if(eq.getLayoutParent()!==this){throw new Error("Remove Error: "+eq+" is not a child of this widget!");
}eq.setLayoutParent(null);
if(this.__ib){this.__ib.invalidateChildrenCache();
}qx.ui.core.queue.Layout.add(this);
if(this._afterRemoveChild){this._afterRemoveChild(eq);
}},capture:function(er){this.getContainerElement().capture(er);
},releaseCapture:function(){this.getContainerElement().releaseCapture();
},_applyPadding:function(es,et,name){this._updateInsets=true;
qx.ui.core.queue.Layout.add(this);
},_createProtectorElement:function(){if(this.__hX){return;
}var eu=this.__hX=new qx.html.Element;
eu.setStyles({position:cj,top:0,left:0,zIndex:7});
var ev=this.getBounds();

if(ev){this.__hX.setStyles({width:ev.width+cd,height:ev.height+cd});
}if((qx.core.Environment.get(bt)==ck)){eu.setStyles({backgroundImage:X+qx.util.ResourceManager.getInstance().toUri(bI)+Y,backgroundRepeat:N});
}this.getContainerElement().add(eu);
},_applyDecorator:function(ew,ex){var eA=qx.ui.core.Widget.__hT;
var ey=this.getContainerElement();
if(!this.__hX&&!qx.core.Environment.get(m)){this._createProtectorElement();
}if(ex){ey.remove(this.__hV);
eA.poolDecorator(this.__hV);
}if(ew){var ez=this.__hV=eA.getDecoratorElement(ew);
ez.setStyle(bP,5);
ey.add(ez);
}else{delete this.__hV;
}this._applyBackgroundColor(this.getBackgroundColor());
if(this.__ic(ex,ew)){this._updateInsets=true;
qx.ui.core.queue.Layout.add(this);
}else if(ew){var eB=this.getBounds();

if(eB){ez.resize(eB.width,eB.height);
this.__hX&&this.__hX.setStyles({width:eB.width+cd,height:eB.height+cd});
}}},_applyShadow:function(eC,eD){var eK=qx.ui.core.Widget.__hU;
var eF=this.getContainerElement();
if(eD){eF.remove(this.__hW);
eK.poolDecorator(this.__hW);
}if(eC){var eH=this.__hW=eK.getDecoratorElement(eC);
eF.add(eH);
var eJ=eH.getInsets();
eH.setStyles({left:(-eJ.left)+cd,top:(-eJ.top)+cd});
var eI=this.getBounds();

if(eI){var eG=eI.width+eJ.left+eJ.right;
var eE=eI.height+eJ.top+eJ.bottom;
eH.resize(eG,eE);
}eH.tint(null);
}else{delete this.__hW;
}},_applyToolTipText:function(eL,eM){if(qx.core.Environment.get(bM)){if(this.__ia){return;
}var eN=qx.locale.Manager.getInstance();
this.__ia=eN.addListener(bD,function(){var eO=this.getToolTipText();

if(eO&&eO.translate){this.setToolTipText(eO.translate());
}},this);
}},_applyTextColor:function(eP,eQ){},_applyZIndex:function(eR,eS){this.getContainerElement().setStyle(bP,eR==null?0:eR);
},_applyVisibility:function(eT,eU){var eV=this.getContainerElement();

if(eT===bY){eV.show();
}else{eV.hide();
}var parent=this.$$parent;

if(parent&&(eU==null||eT==null||eU===bT||eT===bT)){parent.invalidateLayoutChildren();
}qx.ui.core.queue.Visibility.add(this);
},_applyOpacity:function(eW,eX){this.getContainerElement().setStyle(bS,eW==1?null:eW);
if((qx.core.Environment.get(bt)==ck)&&qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){if(!qx.Class.isSubClassOf(this.getContentElement().constructor,qx.html.Image)){var eY=(eW==1||eW==null)?null:0.99;
this.getContentElement().setStyle(bS,eY);
}}},_applyCursor:function(fa,fb){if(fa==null&&!this.isSelectable()){fa=bR;
}this.getContainerElement().setStyle(T,fa,qx.core.Environment.get(bt)==bG);
},_applyBackgroundColor:function(fc,fd){var fe=this.getBackgroundColor();
var fg=this.getContainerElement();

if(this.__hV){this.__hV.tint(fe);
fg.setStyle(cg,null);
}else{var ff=qx.theme.manager.Color.getInstance().resolve(fe);
fg.setStyle(cg,ff);
}},_applyFont:function(fh,fi){},__ij:null,$$stateChanges:null,_forwardStates:null,hasState:function(fj){var fk=this.__ij;
return !!fk&&!!fk[fj];
},addState:function(fl){var fm=this.__ij;

if(!fm){fm=this.__ij={};
}
if(fm[fl]){return;
}this.__ij[fl]=true;
if(fl===cl){this.syncAppearance();
}else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;
}else{qx.ui.core.queue.Appearance.add(this);
}var forward=this._forwardStates;
var fp=this.__im;

if(forward&&forward[fl]&&fp){var fn;

for(var fo in fp){fn=fp[fo];

if(fn instanceof qx.ui.core.Widget){fp[fo].addState(fl);
}}}},removeState:function(fq){var fr=this.__ij;

if(!fr||!fr[fq]){return;
}delete this.__ij[fq];
if(fq===cl){this.syncAppearance();
}else if(!qx.ui.core.queue.Visibility.isVisible(this)){this.$$stateChanges=true;
}else{qx.ui.core.queue.Appearance.add(this);
}var forward=this._forwardStates;
var fu=this.__im;
...
if(fs instanceof qx.ui.core.Widget){fs.removeState(fq);
}}}},replaceState:function(fv,fw){var fx=this.__ij;
...
if(forward&&forward[fw]&&fA){for(var fz in fA){var fy=fA[fz];

if(fy instanceof qx.ui.core.Widget){fy.replaceState(fv,fw);
}}}},__ik:null,__il:null,syncAppearance:function(){var fF=this.__ij;
var fE=this.__ik;
...
fE=fJ.reverse().join(bj).replace(/#[0-9]+/g,bk);
this.__ik=fE;
...
}}this.fireDataEvent(L,this.__ij);
},_applyAppearance:function(fL,fM){this.updateAppearance();
...
if(fN instanceof qx.ui.core.Widget){fN.updateAppearance();
...
},_applyFocusable:function(fS,fT){var fU=this.getFocusElement();
if(fS){var fV=this.getTabIndex();

if(fV==null){fV=1;
}fU.setAttribute(bq,fV);
if((qx.core.Environment.get(bt)==ck)){fU.setAttribute(r,z);
}else{fU.setStyle(t,u);
}}else{if(fU.isNativelyFocusable()){fU.setAttribute(bq,-1);
}else if(fT){fU.setAttribute(bq,null);
}}},_applyKeepFocus:function(fW){var fX=this.getFocusElement();
fX.setAttribute(bH,fW?bv:null);
},_applyKeepActive:function(fY){var ga=this.getContainerElement();
ga.setAttribute(bz,fY?bv:null);
...
if(this.getFocusable()&&gb!=null){this.getFocusElement().setAttribute(bq,gb);
}},_applySelectable:function(gc,gd){if(gd!==null){this._applyCursor(this.getCursor());
}this.getContentElement().setSelectable(gc);
},_applyEnabled:function(ge,gf){if(ge===false){this.addState(cf);
this.removeState(cl);
...
}}},_applyNativeContextMenu:function(gg,gh,name){},_applyContextMenu:function(gi,gj){if(gj){gj.removeState(bs);

if(gj.getOpener()==this){gj.resetOpener();
}
if(!gi){this.removeListener(bs,this._onContextMenuOpen);
gj.removeListener(bo,this._onBeforeContextMenuOpen,this);
}}
if(gi){gi.setOpener(this);
gi.addState(bs);

if(!gj){this.addListener(bs,this._onContextMenuOpen);
gi.addListener(bo,this._onBeforeContextMenuOpen,this);
}}},_onContextMenuOpen:function(e){this.getContextMenu().openAtMouse(e);
e.stop();
},_onBeforeContextMenuOpen:function(e){if(e.getData()==bY&&this.hasListener(f)){this.fireDataEvent(f,e);
}},_onStopEvent:function(e){e.stopPropagation();
},_applyDraggable:function(gk,gl){if(!this.isEnabled()&&gk===true){gk=false;
}qx.ui.core.DragDropCursor.getInstance();
if(gk){this.addListener(cn,this._onDragStart);
this.addListener(ch,this._onDrag);
this.addListener(bO,this._onDragEnd);
this.addListener(bL,this._onDragChange);
}else{this.removeListener(cn,this._onDragStart);
this.removeListener(ch,this._onDrag);
this.removeListener(bO,this._onDragEnd);
this.removeListener(bL,this._onDragChange);
}this.getContainerElement().setAttribute(O,gk?bv:null);
},_applyDroppable:function(gm,gn){if(!this.isEnabled()&&gm===true){gm=false;
}this.getContainerElement().setAttribute(U,gm?bv:null);
},_onDragStart:function(e){qx.ui.core.DragDropCursor.getInstance().placeToMouse(e);
this.getApplicationRoot().setGlobalCursor(bR);
},_onDrag:function(e){qx.ui.core.DragDropCursor.getInstance().placeToMouse(e);
},_onDragEnd:function(e){qx.ui.core.DragDropCursor.getInstance().moveTo(-1000,-1000);
this.getApplicationRoot().resetGlobalCursor();
},_onDragChange:function(e){var go=qx.ui.core.DragDropCursor.getInstance();
var gp=e.getCurrentAction();
gp?go.setAction(gp):go.resetAction();
},visualizeFocus:function(){this.addState(bp);
},visualizeBlur:function(){this.removeState(bp);
},scrollChildIntoView:function(gq,gr,gs,gt){gt=typeof gt==bB?true:gt;
var gu=qx.ui.core.queue.Layout;
var parent;
if(gt){gt=!gu.isScheduled(gq);
parent=gq.getLayoutParent();
if(gt&&parent){gt=!gu.isScheduled(parent);
if(gt){parent.getChildren().forEach(function(gv){gt=gt&&!gu.isScheduled(gv);
});
}}}this.scrollChildIntoViewX(gq,gr,gt);
...
},scrollChildIntoViewY:function(gz,gA,gB){this.getContentElement().scrollChildIntoViewY(gz.getContainerElement(),gA,gB);
...
},hasChildControl:function(gC){if(!this.__im){return false;
}return !!this.__im[gC];
},__im:null,_getCreatedChildControls:function(){return this.__im;
},getChildControl:function(gD,gE){if(!this.__im){if(gE){return null;
}this.__im={};
}var gF=this.__im[gD];
...
if(gJ){gJ.exclude();
}},_isChildControlVisible:function(gK){var gL=this.getChildControl(gK,true);

if(gL){return gL.isVisible();
}return false;
},_createChildControl:function(gM){if(!this.__im){this.__im={};
}else if(this.__im[gM]){throw new Error("Child control '"+gM+"' already created!");
}var gQ=gM.indexOf(P);

if(gQ==-1){var gN=this._createChildControlImpl(gM);
}else{var gN=this._createChildControlImpl(gM.substring(0,gQ),gM.substring(gQ+1,gM.length));
}
...
}}}this.fireDataEvent(cq,gN);
return this.__im[gM]=gN;
},_createChildControlImpl:function(gR,gS){return null;
},_disposeChildControls:function(){var gW=this.__im;

if(!gW){return;
}var gU=qx.ui.core.Widget;

for(var gV in gW){var gT=gW[gV];

if(!gU.contains(this,gT)){gT.destroy();
}else{gT.dispose();
}}delete this.__im;
...
},getContainerLocation:function(gY){var ha=this.getContainerElement().getDomElement();
...
},setDomLeft:function(hd){var he=this.getContainerElement().getDomElement();

if(he){he.style.left=hd+cd;
}else{throw new Error("DOM element is not yet created!");
}},setDomTop:function(hf){var hg=this.getContainerElement().getDomElement();

if(hg){hg.style.top=hf+cd;
}else{throw new Error("DOM element is not yet created!");
}},setDomPosition:function(hh,top){var hi=this.getContainerElement().getDomElement();

if(hi){hi.style.left=hh+cd;
hi.style.top=top+cd;
}else{throw new Error("DOM element is not yet created!");
...
},clone:function(){var hj=qx.ui.core.LayoutItem.prototype.clone.call(this);

if(this.getChildren){var hk=this.getChildren();

for(var i=0,l=hk.length;i<l;i++){hj.add(hk[i].clone());
}}return hj;
}},destruct:function(){if(!qx.core.ObjectRegistry.inShutDown){if(qx.core.Environment.get(bM)){if(this.__ia){qx.locale.Manager.getInstance().removeListenerById(this.__ia);
...
}if(!qx.core.ObjectRegistry.inShutDown){var hm=qx.ui.core.Widget;
var hl=this.getContainerElement();

if(this.__hV){hl.remove(this.__hV);
hm.__hT.poolDecorator(this.__hV);
}
if(this.__hW){hl.remove(this.__hW);
hm.__hU.poolDecorator(this.__hW);
...
this._disposeObjects(R,h,cp,bC);
}});
})();
...
qx.Bootstrap.define(a,{statics:{__cN:{},__iP:{width:null,height:null},__iQ:/\.(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__cN[d];
return !!(e&&e.loaded);
...
},__iR:qx.event.GlobalError.observeMethod(function(event,D,E){var F=this.__cN[E];
...
}},properties:{source:{check:r,init:null,nullable:true,event:w,apply:p,themeable:true},scale:{check:a,init:false,themeable:true,apply:m},appearance:{refine:true,init:o},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:d,loaded:d},members:{__jp:null,__jq:null,__fv:null,__jo:null,getContentElement:function(){return this.__ju();
...
},__jr:function(E){this.__fv=E;
},__js:function(){if(this.__fv==null){var G=this.getSource();
var F=false;
...
},__jC:function(bo,bp){if(bo!==this.__jp||bp!==this.__jq){this.__jp=bo;
this.__jq=bp;
qx.ui.core.queue.Layout.add(this);
...
qx.Class.define(a,{type:b,extend:qx.core.Object,members:{__hB:null,_invalidChildrenCache:null,__ip:null,invalidateLayoutCache:function(){this.__hB=null;
...
},verifyLayoutProperty:null,_clearSeparators:function(){var f=this.__ip;

if(f instanceof qx.ui.core.LayoutItem){f.clearSeparators();
}},_renderSeparator:function(g,h){this.__ip.renderSeparator(g,h);
...
}},destruct:function(){this.__ip=this.__hB=null;
}});
})();
...
(function(){var i="qx.ui.window.Window",h="changeModal",g="changeVisibility",f="changeActive",d="_applyActiveWindow",c="__eI",b="__jU",a="qx.ui.window.MDesktop";
qx.Mixin.define(a,{properties:{activeWindow:{check:i,apply:d,init:null,nullable:true}},members:{__jU:null,__eI:null,getWindowManager:function(){if(!this.__eI){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());
}return this.__eI;
...
this.__kn={};
},members:{__kn:null,__ko:null,__kp:null,__kq:null,connectTo:function(m){m.addListener(k,this.__gq,this);
...
w.visualizeBlur();
}},__gq:function(e){if(e.getKeyIdentifier()!=f){return;
}
if(!this.__kq){return;
}e.stopPropagation();
e.preventDefault();
...
qx.Class.define(g,{extend:qx.ui.root.Abstract,construct:function(o){this.__bJ=qx.dom.Node.getWindow(o);
this.__kB=o;
qx.ui.root.Abstract.call(this);
qx.event.Registration.addListener(this.__bJ,n,this._onResize,this);
this._setLayout(new qx.ui.layout.Canvas());
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
this.getContentElement().disableScrolling();
},members:{__bJ:null,__kB:null,_createContainerElement:function(){var p=this.__kB;
...
},_computeSizeHint:function(){var u=qx.bom.Viewport.getWidth(this.__bJ);
var v=qx.bom.Viewport.getHeight(this.__bJ);
...
}}},destruct:function(){this.__bJ=this.__kB=null;
}});
})();
...
(function(){var a='bio.phisics.IForce';
qx.Interface.define(a,{properties:{direction:{},strength:{}},members:{copy:function(){},equals:function(b){this.assertInterface(b,bio.phisics.IForce);
},modifyDirection:function(c){this.assertNumber(c);

if(isNaN(c)){throw new Error('value is NaN');
}},modifyStrength:function(d){this.assertNumber(d);

if(isNaN(d)){throw new Error('value is NaN');
}},getVector:function(){},merge:function(e){this.assertInterface(e,bio.phisics.IForce);
}}});
})();
(function(){var g='Number',f=' { direction: ',e=' }',d=', strength: ',c='bio.phisics.Force',b='_transformStrength',a='_applyDirection';
qx.Class.define(c,{extend:qx.core.Object,implement:bio.phisics.IForce,construct:function(h,i){this.__qr=new bio.phisics.Degree;
var j=arguments.length;

if(j>0){if(j>1){this.setStrength(i);
}this.setDirection(h);
}},properties:{direction:{apply:a,nullable:false,check:g,init:0},strength:{transform:b,nullable:false,check:g,init:0}},members:{__qr:null,copy:function(){return new bio.phisics.Force(this.getDirection(),this.getStrength());
},equals:function(k){return (this.getDirection()===k.getDirection()&&this.getStrength()===k.getStrength());
},getDirection:function(){return this.__qr.getValue();
},modifyDirection:function(l){this.__qr.add(l);
return this;
},modifyStrength:function(m){this.setStrength(this.getStrength()+m);
return this;
},getVector:function(){return this.__qr.toVector().multiply(this.getStrength());
},merge:function(n){var o=this.getVector();
var p=n.getVector();
o.merge(p);
this.setStrength(o.getHypotenuse());
this.setDirection(o.getAngle());
return this;
},toString:function(){return qx.core.Object.prototype.toString.call(this)+f+this.getDirection()+d+this.getStrength()+e;
},_applyDirection:function(q){this.__qr.setValue(q);
},_transformStrength:function(r){if(r<0){this.__qr.setValue(this.__qr.getValue()-180);
r*=-1;
}return r;
}}});
})();
(function(){var c='_transformValue',b='Number',a='bio.phisics.Degree';
qx.Class.define(a,{extend:qx.core.Object,construct:function(d){if(arguments.length>1){this.setValue(d);
}},properties:{value:{transform:c,nullable:false,check:b,init:0}},members:{copy:function(){return new bio.phisics.Force.Degree(this.getValue());
},equals:function(e){return this.getValue()===e.getValue();
},add:function(f){this.setValue(this.getValue()+f);
},toRadian:function(){return this.getValue()*Math.PI/180;
},toVector:function(){var g=this.toRadian();
return new bio.phisics.Vector(Math.cos(g),Math.sin(g));
},_transformValue:function(h){h%=360;

if(h<0){h+=360;
}return h;
}}});
})();
(function(){var b="qx.event.type.DataEvent",a='bio.phisics.IVector';
qx.Interface.define(a,{properties:{x:{},y:{}},events:{'changeX':b,'changeY':b},members:{isZero:function(){},copy:function(){},equals:function(c){this.assertInterface(c,bio.phisics.IVector);
},merge:function(d){this.assertInterface(d,bio.phisics.IVector);
},diff:function(e){this.assertInterface(e,bio.phisics.IVector);
},add:function(f){this.assertNumber(f);

if(isNaN(f)){throw new Error('value is NaN');
}},multiply:function(g){this.assertNumber(g);

if(isNaN(g)){throw new Error('value is NaN');
}},abs:function(){},round:function(h){this.assertArgumentsCount(arguments,0,1);

if(arguments.length===1){this.assertPositiveInteger(h);
}},getHypotenuse:function(){},getAngleRadians:function(){},getAngle:function(){}}});
})();
(function(){var h='Number',g='changeX',f='changeY',e='bio.phisics.Vector',d=', y: ',c=' { x: ',b=', }',a='undefined';
qx.Class.define(e,{extend:qx.core.Object,implement:bio.phisics.IVector,construct:function(x,y){var i=arguments.length;

if(i>0){if(i===1){y=x;
}this.setX(x);
this.setY(y);
}},properties:{x:{event:g,check:h,init:0},y:{event:f,check:h,init:0}},members:{__qs:{},isZero:function(){return this.getX()===0&&this.getY()===0;
},copy:function(){return new bio.phisics.Vector(this.getX(),this.getY());
},equals:function(j){return this.getX()===j.getX()&&this.getY()===j.getY();
},merge:function(k){this.setX(this.getX()+k.getX());
this.setY(this.getY()+k.getY());
return this;
},diff:function(l){return new bio.phisics.Vector(this.getX()-l.getX(),this.getY()-l.getY());
},add:function(m){this.setX(this.getX()+m);
this.setY(this.getY()+m);
return this;
},multiply:function(n){this.setX(this.getX()*n);
this.setY(this.getY()*n);
return this;
},abs:function(){this.setX(Math.abs(this.getX()));
this.setY(Math.abs(this.getY()));
return this;
},round:function(o){var p=this.__qs[o];

if(typeof p===a){var q=arguments.length===0?2:o;
p=Math.pow(10,q);
this.__qs[o]=p;
}this.setX(Math.round(this.getX()*p)/p);
this.setY(Math.round(this.getY()*p)/p);
return this;
},getHypotenuse:function(){if(this.isZero()){return 0;
}return Math.sqrt(Math.pow(this.getX(),2)+Math.pow(this.getY(),2),2);
},getAngleRadians:function(){if(this.isZero()){return 0;
}var r=Math.atan(this.getY()/this.getX());

if(r<0){r+=Math.PI;
}
if(this.getY()<0||(this.getY()===0&&this.getX<0)){r+=Math.PI;
}return r;
},getAngle:function(){var s=this.getAngleRadians()/Math.PI*180;

while(s<0){s+=360;
}return s%360;
},toString:function(){return qx.core.Object.prototype.toString.call(this)+c+this.getX()+d+this.getY()+b;
}}});
})();
...
}},members:{__mF:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__mF;
},getMarkup:function(e){if(this.__mF){return this.__mF;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__qo;
this._resizeBorder=this.__qn;
this._styleBorder=this.__ql;
this._generateMarkup=this.__qm;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__qk:null,__ql:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__qm:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__qk=this._generateBackgroundMarkup(G,J);
},__qn:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__qo:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__mF:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__mF;
},_applyStyle:function(){},getMarkup:function(){if(this.__mF){return this.__mF;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__qp=new qx.ui.decoration.css3.BorderImage();

if(p){this.__qq(p);
}}else{this.__qp=new qx.ui.decoration.GridDiv(p);
}
if(q!=null){this.__qp.setInsets(q);
}},properties:{baseImage:{check:d,nullable:true,apply:j},insetLeft:{check:o,nullable:true,apply:n},insetRight:{check:o,nullable:true,apply:n},insetBottom:{check:o,nullable:true,apply:n},insetTop:{check:o,nullable:true,apply:n},insets:{group:[k,l,i,e],mode:f}},members:{__qp:null,getMarkup:function(){return this.__qp.getMarkup();
},resize:function(r,s,t){this.__qp.resize(r,s,t);
},tint:function(u,v){},getInsets:function(){return this.__qp.getInsets();
},_applyInsets:function(w,x,name){var y=g+qx.lang.String.firstUp(name);
this.__qp[y](w);
},_applyBaseImage:function(z,A){if(this.__qp instanceof qx.ui.decoration.GridDiv){this.__qp.setBaseImage(z);
}else{this.__qq(z);
}},__qq:function(B){var G,H,J,I;
this.__qp.setBorderImage(B);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__mF:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__mF;
...
this.__mF=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__mF;
